...
Note: The following code was repurposed from the PyAbel project
...
def reproject_image_into_polar2D(data, origin=None, Jacobian=False,
                               dr=1, dt=None):
...
def reproject_image_into_polar3D(data, origin=None):
